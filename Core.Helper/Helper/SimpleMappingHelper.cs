...
public static class SimpleMappingHelper
{
    /// <summary>
    ...
    ///     Return exception if can create instance for typeof t to
    /// </exception>
    public static TTo? Mapping<TFrom, TTo>(TFrom mapFrom) where TFrom : class, new()  
        where TTo : class
    {
    ...
    ///     Return exception if can create instance for typeof t to
    /// </exception>
    public static List<TTo> Mapping<TFrom, TTo>(List<TFrom> mapFrom) where TFrom : class, new()
        where TTo : class
    {
        List<TTo> result = [];
        var typeTo = typeof(TTo);
